...
print(member2.member, member1.member)

//examples for number six Team Senegal
var member3 = Member(name: "Player 1 Senegal",
                     age: 34,
                     type: Member.DifferentType.Player,
                     position: PlayerPosition.LateralIzquierdo)
var member4 = Member(name: "Player 2 Senegal",
                     age: 25,
                     type: Member.DifferentType.Player,
                     position: PlayerPosition.Delantero)
...
class Team {
  ...
  init(country: Country,  players: [Member]) {
